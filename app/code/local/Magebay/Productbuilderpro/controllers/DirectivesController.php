...
class Magebay_Productbuilderpro_DirectivesController extends Mage_Core_Controller_Front_Action
{
    ...
    {
        echo $this->getLayout()->createBlock("core/template")->setTemplate("productbuilderpro/directives/core/pbp-group.phtml")->toHtml();
    }
    public function pbpOptionCollectionAction() {
        echo $this->getLayout()->createBlock("core/template")->setTemplate("productbuilderpro/directives/core/pbp-option-collection.phtml")->toHtml();
    }
    public function pbpOptionDetailsAction() {
        echo $this->getLayout()->createBlock("core/template")->setTemplate("productbuilderpro/directives/core/pbp-option-details.phtml")->toHtml();
    }
    // Frontend
    ...
    public function pbpMediaAction() {
        echo $this->getLayout()->createBlock("core/template")->setTemplate("productbuilderpro/directives/core/pbp-media.phtml")->toHtml();
    }
